...
export const ACTOR_TYPES = {
  ...
  CRYSTAL: "crystal[s]",
  LIFE_CRYSTAL: "life crystal[s]",
  POWER_CRYSTAL: "power crystal[s]",
  DUST: "dust[s]",
  SPEED_DUST: "speed dust[s]",
  NEUTRAL_HUMANOID: "neutral humanoid[s]",
  MERCHANT: "merchant[s]",
};
...
Actors.ActorFactory.registerActorDef({
  name: ACTOR_TYPES.NEUTRAL_HUMANOID,
  abstract: true,
  ai: {
    type: Actors.AiTypeEnum.NEUTRAL,
    walkTime: 4,
    // // shorter syntax
    // treeName: BEHAVIOR_TREES.BASIC_HOSTILE,
  },
...
Actors.ActorFactory.registerActorDef({
  name: ACTOR_TYPES.MERCHANT,
  ai: { type: Actors.AiTypeEnum.NEUTRAL, walkTime: 4 },
  ch: "m",
  color: 0x3f7f3f,

  prototypes: [ACTOR_TYPES.NEUTRAL_HUMANOID],
});
Actors.ActorFactory.registerActorDef({
...
Actors.ActorFactory.registerActorDef({
  ...
  prototypes: [ACTOR_TYPES.DUST],
});
Actors.ActorFactory.registerActorDef({
  name: ACTOR_TYPES.POWER_CRYSTAL,
  color: OIL_FLASK_COLOR,
  pickable: {
    onUseEffector: {
      destroyOnEffect: true,
  ...
  prototypes: [ACTOR_TYPES.CRYSTAL],
});
Actors.ActorFactory.registerActorDef({
  name: ACTOR_TYPES.LIFE_CRYSTAL,
  color: OIL_FLASK_COLOR,
  pickable: {
    onUseEffector: {
      destroyOnEffect: true,
